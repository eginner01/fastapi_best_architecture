...
class Step(Base):
    ...
    assignee_name: Mapped[str | None] = mapped_column(sa.String(100), default=None, comment='审批人姓名')
    ...
    settings: Mapped[str | None] = mapped_column(sa.JSON, default=None, comment='步骤配置')
