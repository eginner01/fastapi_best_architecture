...
class FlowLine(Base):
    ...
    line_no: Mapped[str] = mapped_column(sa.String(50), default='', comment='流程线编号')
    ...
    condition_expression: Mapped[str | None] = mapped_column(sa.String(500), default=None, comment='条件表达式')
    ...
    settings: Mapped[str | None] = mapped_column(sa.JSON, default=None, comment='连线配置')
